...
## Proposed Canonical Intermediate

If approved, the parent orchestrator should write the canonical intermediate to:

- `research/competitive-analysis-strategic-group-map.md`

It should then archive this working packet and the review page under `docs/history/archive/YYYY-MM-DD/HHMMSS/`, remove the active working packet, and let the next parent run synthesize all approved frameworks into `research/competitive-analysis.md`.

## Out Of Scope For This Intermediate

- Canonical `research/competitive-analysis-strategic-group-map.md`.
