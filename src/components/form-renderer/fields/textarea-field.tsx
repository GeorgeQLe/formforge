...
export function TextareaField({ field, value, onChange, error, readonly }: FieldComponentProps) {
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 disabled:opacity-60 disabled:cursor-not-allowed resize-y"
      />
      {error && (
